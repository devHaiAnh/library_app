...
class BooksTrending {
  ...
  factory BooksTrending.fromRawJson(String str) =>
      BooksTrending.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory BooksTrending.fromJson(Map<String, dynamic> json) => BooksTrending(
